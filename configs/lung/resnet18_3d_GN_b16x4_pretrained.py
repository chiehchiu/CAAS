...
model = dict(
    ...
    pretrained='/lung_general_data/pretrained_model/imagenet_pretrain3d/res3d18_imagenet_GN_final_72.18.pth',
    # pretrained=None,
    backbone=dict(
        type='ResNet3D',
        depth=18,
...
workflow = [('train', 1)]
work_dir = '/data2/lianjie/lung_general_data/lung_batch1234/models/resnet18_3d_GN_b16x4_pretrained/'
