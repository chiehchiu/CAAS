...
model = dict(
    ...
    pretrained='/lung_general_data/pretrained_model/imagenet_pretrain3d/res3d101_imagenet_BN_final_78.69.pth',
    # pretrained=None,
    backbone=dict(
        type='ResNet3D',
        depth=101,
...
workflow = [('train', 1)]
work_dir = '/data2/lianjie/lung_general_data/lung_batch1234/models/resnet101_3d_BN_b4x4_pretrained/'
