...
model = dict(
    ...
    #pretrained='/data3/lizihao/code/mmclassification/pretrained_models/res3d18_coco_GN.pth',
    pretrained='/data3/lizihao/code/mmclassification/pretrained_models/res3d18_imagenet_GN.pth',
    backbone=dict(
        type='ResNet3D',
        depth=18,
        num_stages=4,
